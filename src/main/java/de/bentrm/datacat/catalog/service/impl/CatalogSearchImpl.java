...
public class CatalogSearchImpl implements CatalogSearchService {
    ...
    public CatalogSearchImpl(Neo4jTemplate neo4jTemplate) {
    ...
    public Page<XtdObject> search(CatalogRecordSpecification specification) {
        ...
        final long count = neo4jTemplate.count(XtdObject.class);
        ...
        if (paged.isPresent()) {
            ...
            if (pageable.getSort().isUnsorted()) {
                ...
                catalogRecords = neo4jTemplate.findAll(XtdObject.class);
            } else {
    ...
    public long count(CatalogRecordSpecification specification) {
        ...
        return neo4jTemplate.count(XtdObject.class);
    }
}
