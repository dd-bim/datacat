...
public class DictionaryRecordServiceImpl
    ...
    public DictionaryRecordServiceImpl(SessionFactory sessionFactory,
                                     DictionaryRepository repository,
                                     MultiLanguageTextRepository multiLanguageTextRepository,
                                     CatalogCleanupService cleanupService) {
        super(XtdDictionary.class, sessionFactory, repository, cleanupService);
    ...
    public @NotNull XtdDictionary setRelatedRecords(@NotBlank String recordId,
        ...
        final XtdDictionary dictionary = getRepository().findById(recordId, 0).orElseThrow();
