...
public class AbstractServiceImpl<T extends Entity> implements QueryService<T> {

    private final Class<T> domainClass;
    private final SessionFactory sessionFactory;
    private final EntityRepository<T> repository;

    public AbstractServiceImpl(Class<T> domainClass, SessionFactory sessionFactory, EntityRepository<T> repository) {
