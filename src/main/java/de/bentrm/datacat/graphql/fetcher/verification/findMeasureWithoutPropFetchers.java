...
import de.bentrm.datacat.catalog.service.value.verification.findMeasureWithoutPropValue;
...
@Slf4j
@Component
public class findMeasureWithoutPropFetchers implements QueryFetchers {
    ...
    public Map<String, DataFetcher> getQueryFetchers() {
        return Map.ofEntries(
                ...
                Map.entry("findMeasureWithoutProp", findMeasureWithoutProp())
        );
    }
    ...
    public DataFetcher<findMeasureWithoutPropValue> findMeasureWithoutProp() {
        return environment -> {
            return catalogVerificationService.getfindMeasureWithoutProp();
        };
    };
}
