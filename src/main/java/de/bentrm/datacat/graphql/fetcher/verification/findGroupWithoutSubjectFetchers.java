...
import de.bentrm.datacat.catalog.service.value.verification.findGroupWithoutSubjectValue;
...
@Slf4j
@Component
public class findGroupWithoutSubjectFetchers implements QueryFetchers {
    ...
    public Map<String, DataFetcher> getQueryFetchers() {
        return Map.ofEntries(
                ...
                Map.entry("findGroupWithoutSubject", findGroupWithoutSubject())
        );
    }
    ...
    public DataFetcher<findGroupWithoutSubjectValue> findGroupWithoutSubject() {
        return environment -> {
            return catalogVerificationService.getfindGroupWithoutSubject();
        };
    };
}
