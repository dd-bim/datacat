...
import de.bentrm.datacat.catalog.service.value.verification.findPropWithoutSubjectOrPropGroupValue;
...
@Slf4j
@Component
public class findPropWithoutSubjectOrPropGroupFetchers implements QueryFetchers {
    ...
    public Map<String, DataFetcher> getQueryFetchers() {
        return Map.ofEntries(
                ...
                Map.entry("findPropWithoutSubjectOrPropGroup", findPropWithoutSubjectOrPropGroup())
        );
    }
    ...
    public DataFetcher<findPropWithoutSubjectOrPropGroupValue> findPropWithoutSubjectOrPropGroup() {
        return environment -> {
            return catalogVerificationService.getfindPropWithoutSubjectOrPropGroup();
        };
    };
}
