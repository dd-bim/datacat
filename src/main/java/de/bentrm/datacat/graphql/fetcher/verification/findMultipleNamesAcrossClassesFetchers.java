...
import de.bentrm.datacat.catalog.service.value.verification.findMultipleNamesAcrossClassesValue;
...
import de.bentrm.datacat.graphql.input.verification.findMultipleNamesAcrossClassesFilterInput;
import de.bentrm.datacat.graphql.input.verification.findMultipleNamesAcrossClassesNodeTypeFilterInput;
...
@Slf4j
@Component
public class findMultipleNamesAcrossClassesFetchers implements QueryFetchers {
    ...
    public Map<String, DataFetcher> getQueryFetchers() {
        return Map.ofEntries(
                ...
                Map.entry("findMultipleNamesAcrossClasses", findMultipleNamesAcrossClasses())
        );
    }
    ...
    public DataFetcher<findMultipleNamesAcrossClassesValue> findMultipleNamesAcrossClasses() {
        return environment -> {
            Map<String, Object> argument = environment.getArgument("input");
            final findMultipleNamesAcrossClassesFilterInput input = inputMapper.tofindMultipleNamesAcrossClassesFilterInput(argument);
            final findMultipleNamesAcrossClassesNodeTypeFilterInput nodeTypeFilter = input.getNodeTypeFilter();
            final CatalogRecordSpecification catalogEntryType = specificationMapper.toCatalogRecordSpecification(nodeTypeFilter);
            return catalogVerificationService.getfindMultipleNamesAcrossClasses(catalogEntryType);
        };
    }
