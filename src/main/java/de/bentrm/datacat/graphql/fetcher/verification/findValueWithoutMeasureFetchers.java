...
import de.bentrm.datacat.catalog.service.value.verification.findValueWithoutMeasureValue;
...
@Slf4j
@Component
public class findValueWithoutMeasureFetchers implements QueryFetchers {
    ...
    public Map<String, DataFetcher> getQueryFetchers() {
        return Map.ofEntries(
                ...
                Map.entry("findValueWithoutMeasure", findValueWithoutMeasure())
        );
    }
    ...
    public DataFetcher<findValueWithoutMeasureValue> findValueWithoutMeasure() {
        return environment -> {
            return catalogVerificationService.getfindValueWithoutMeasure();
        };
    };
}
