...
import de.bentrm.datacat.catalog.service.value.verification.findUnitWithoutMeasureValue;
...
@Slf4j
@Component
public class findUnitWithoutMeasureFetchers implements QueryFetchers {
    ...
    public Map<String, DataFetcher> getQueryFetchers() {
        return Map.ofEntries(
                ...
                Map.entry("findUnitWithoutMeasure", findUnitWithoutMeasure())
        );
    }
    ...
    public DataFetcher<findUnitWithoutMeasureValue> findUnitWithoutMeasure() {
        return environment -> {
            return catalogVerificationService.getfindUnitWithoutMeasure();
        };
    };
}
