...
@Slf4j
@Component
public class findModelWithoutGroupFetchers implements QueryFetchers {
    ...
    public Map<String, DataFetcher> getQueryFetchers() {
        return Map.ofEntries(
                ...
                Map.entry("findModelWithoutGroup", findModelWithoutGroup())
        );
    }
    ...
    public DataFetcher<findModelWithoutGroupValue> findModelWithoutGroup() {
        return environment -> {
            return catalogVerificationService.getfindModelWithoutGroup();
        };
    };
}
