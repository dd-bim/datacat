...
@Component
public class RelComposesFetchers extends AssociationFetchers<XtdRelComposes> {

    public RelComposesFetchers(ComposesService entityService, CatalogService catalogService) {
