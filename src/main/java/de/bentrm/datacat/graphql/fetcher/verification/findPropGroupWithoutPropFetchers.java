...
import de.bentrm.datacat.catalog.service.value.verification.findPropGroupWithoutPropValue;
...
@Slf4j
@Component
public class findPropGroupWithoutPropFetchers implements QueryFetchers {
    ...
    public Map<String, DataFetcher> getQueryFetchers() {
        return Map.ofEntries(
                ...
                Map.entry("findPropGroupWithoutProp", findPropGroupWithoutProp())
        );
    }
    ...
    public DataFetcher<findPropGroupWithoutPropValue> findPropGroupWithoutProp() {
        return environment -> {
            return catalogVerificationService.getfindPropGroupWithoutProp();
        };
    };
}
